defmodule AshAgentStudio.OverviewLive do
  ...
  def mount(_params, session, socket) do
    ...
    if connected? do
      Phoenix.PubSub.subscribe(AshAgentStudio.PubSub, "ash_agent_studio:runs")
    end
  ...
  def render(assigns) do
    ~H"""
    <Layouts.app flash={@flash} base_path={@base_path} current_page={:observe}>
