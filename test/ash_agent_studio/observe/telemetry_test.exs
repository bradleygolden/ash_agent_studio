defmodule AshAgentStudio.Observe.TelemetryTest do
  ...
  test "records progressive disclosure events and broadcasts run events" do
    ...
    PubSub.subscribe(AshAgentStudio.PubSub, "ash_agent_studio:runs")
    ...
    PubSub.subscribe(AshAgentStudio.PubSub, "ash_agent_studio:runs:#{run_id}")
