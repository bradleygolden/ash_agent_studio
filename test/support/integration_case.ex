defmodule AshAgentStudio.IntegrationCase do
  @moduledoc """
  ...
  ## Usage
      ...
      defmodule AshAgentStudio.Integration.ReqLLM.OpenAI.MetadataTest do
      ...
      defmodule AshAgentStudio.Integration.Ollama.StreamingTest do
        use AshAgentStudio.IntegrationCase, provider: :ollama
